...
This project is indexed by GitNexus as **llm-council-plus** (1388 symbols, 2161 relationships, 97 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/llm-council-plus/context` | Codebase overview, check index freshness |
| `gitnexus://repo/llm-council-plus/clusters` | All functional areas |
| `gitnexus://repo/llm-council-plus/processes` | All execution flows |
| `gitnexus://repo/llm-council-plus/process/{name}` | Step-by-step execution trace |
